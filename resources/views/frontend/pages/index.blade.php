                ...
                <div class="col-md-12 col-lg-3">
                    <div class="main-home-sidebar-banner">
                        <div class="ads loaded">
                            <a href="">
                            <img src="{{ asset($siteslider->slider_img)}}" alt="home |Budget Desktop PC" width="300" height="">
                        </a>
                        </div>
                        <div class="ads loaded m-t-30">
                            <a href="">
                            <img src="{{ asset($siteslider->slider_img_one)}}" alt="home |Budget Desktop PC" width="300" height="">
                        </a>
                        </div>
                    </div>
...
{{--
                            ...
                            <a href="{{ route('category.view', ['category_slug' => $category->category_slug]) }}" class="cat-item-inner">
                                <span class="cat-icon">
                                    <img src="{{ asset($category->category_img) }}" alt="Drone" width="48" height="48">
                                </span>
