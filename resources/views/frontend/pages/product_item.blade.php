<div class="p-item-inner">
    <div class="p-item-img"><a href="{{ url('product/' . $item->product_slug) }}"><img src="{{ asset($item->image_one) }}"
                alt="{{ $item->product_name }}" width="228" height="228"></a>
    </div>
    <div class="p-item-details">
        <h4 class="p-item-name"> <a href="{{ url('product/' . $item->product_slug) }}">{{ $item->product_name }}</a>
        </h4>
