        ...
        <div class="container c-intro">
            <ul class="breadcrumb" itemscope itemtype="">
                ...
                <li itemprop="itemListElement" itemscope itemtype=""><a itemtype="" itemprop="item"
                        href="{{ route('brand.all') }}"><span itemprop="name">Brand</span></a>
        ...
        {{-- <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="shop-banner" style="text-align: center;">
                        @if (isset($brand->brand_logo))
                            <img src="{{ asset($brand->brand_logo) }}" style="width: 150px; height:150px"
                                alt="">
                        @else
                            Img not available
                        @endif
                    ...
                    <div class="top-bar ws-box">
                        <div class="row">
                            <div class="col-sm-4 col-xs-2 actions">
                                ...
                                <label class="page-heading m-hide"></label>
                            </div>
