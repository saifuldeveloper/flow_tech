            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="shop-banner">
                        {{-- @php
                            dd($category->category_banner_img);
                        @endphp --}}
                        {{-- category->category_banner_imgphp --}}
                        ...
                        @if(isset($category) && isset($category->category_banner_img))
        ...
        <div class="container c-intro">
            <ul class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                ...
                @php
                    // dd($category);
                @endphp
                @if(isset($category) && isset($category->category_banner_text))
            ...
            <div class="child-list">
                ...
                @foreach ($category1 as $row)
                    <a href="{{ route('category.view', ['category_slug' => $row->category_slug]) }}">{{ $category->subcategory_name }}</a>
            ...
            {{-- <div class="child-list">
                ...
                @if ($category)
                    <a href="{{ route('category.view', ['category_slug' => $category->category_slug]) }}">
                        {{ $category->subCategories->implode('subcategory_name') }}
                    </a>
                @else
