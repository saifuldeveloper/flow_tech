    ...
    <div class="container">
        <div class="main-footer">
            ...
            <div class="footer-block org-info">
                ...
                <p ><b>Email:</b><br/><a href="" style="color: #fff" target="_blank">{{$setting->email}}</a> </p>
            </div>
        </div>
       ...
       <div class="row footer-two">
        ...
        <div class="col-md-3">
            <div class="payment">
                ...
                <a href="" >
                    <img src="{{asset('assets/fontend/image/footer-ipay.webp')}}" alt="" width="300px;" style="margin-right: 10px; ">
                </a>
            </div>
        </div>
        <div class="col-md-3">
