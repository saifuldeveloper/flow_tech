          ...
          <div class="card-body">
            <div class="table-responsive">
              ...
              <tbody>
                ...
                <td class="text-right">
                  <select class="form-select delivery_section" aria-label="Default select example" onchange="status_update({{ $row->id }},this.value)">
                    @if ($row->status == 0)
                    <option selected disabled class="fw-bold text-warning">Pending</option>
                @elseif ($row->status == 1)
                    <option selected disabled class="fw-bold text-info">Completed</option>
                @elseif ($row->status == 2)
                    <option selected disabled class="fw-bold text-danger">Decline</option>
                @elseif ($row->status == 3)
