        ...
        <div class="col-md-6 grid-margin stretch-card ">
          <div class="card bg-light">
            <div class="card-body">
              ...
              <form class="forms-sample" action="{{ route('update.slider.site',$homesitesliders->id)}}" method="post" enctype="multipart/form-data">
                @csrf 
                ...
                <div class="form-group">
                    ...
                    <img id="logo-preview" src="{{ URL::to($homesitesliders->slider_img) }}"  style="max-width: 200px;" >
