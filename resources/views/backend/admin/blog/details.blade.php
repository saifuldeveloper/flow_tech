          ...
          <div class="card bg-light">
            <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="brand_name" value="{{$blog->autor_name}}" readonly>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="meta_tag" class="form-control" id="size" readonly data-role="tagsinput" value="{{ $blog->meta_tag}}">
              ...
              <div class="form-group">
                ...
                <center>  
                    ...
                    <br>
                    <img id="logo-preview" src="{{ URL::to($blog->image) }}" alt="Brand Logo" style="max-width: 400px;" required>
